...
--
delete from KRIM_ROLE_PERM_T where ROLE_ID in (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE ROLE_NM = 'View Institutionally Maintained Salaries Document Level' AND NMSPC_CD = 'KC-PD')
/
