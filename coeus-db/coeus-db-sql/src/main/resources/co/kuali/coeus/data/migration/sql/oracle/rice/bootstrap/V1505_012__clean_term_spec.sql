...
UPDATE krms_term_spec_t SET NM = 'totalCost' where NMSPC_CD = 'KC-PD' and NM = 'sumTotalCostAmountFromPeriods';
UPDATE krms_term_spec_t SET NM = 'totalDirectCost' where NMSPC_CD = 'KC-PD' and NM = 'sumDirectCostAmountFromPeriods';
UPDATE krms_term_spec_t SET NM = 'totalIndirectCost' where NMSPC_CD = 'KC-PD' and NM = 'sumIndirectCostAmountFromPeriods';
