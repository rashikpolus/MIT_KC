...
EXIT WHEN c_attach%notfound;
		...
		WHERE PROTOCOL_NUMBER = coeus_proto_num AND SEQUENCE_NUMBER = kc_seq and document_id = coeus_doc_id;
		...
		IF li_count = 0 THEN
			...
			begin
				...
				VALUES(li_file_id,kc_seq,r_attach.FILE_NAME,ls_content_type,r_attach.DOCUMENT,li_ver_nbr,r_attach.UPDATE_TIMESTAMP,LOWER(r_attach.UPDATE_USER),SYS_GUID());
				...
				VALUES(li_pa_id,li_protocol_id,coeus_proto_num,kc_seq,r_attach.DOCUMENT_TYPE_CODE,r_attach.DOCUMENT_ID,li_file_id,r_attach.DESCRIPTION,NULL,NULL,NULL,NULL,NULL,li_ver_nbr,r_attach.UPDATE_TIMESTAMP,r_attach.UPDATE_USER,SYS_GUID(),r_attach.DOCUMENT_STATUS_CODE,LOWER(r_attach.UPDATE_TIMESTAMP),r_attach.VERSION_NUMBER);
