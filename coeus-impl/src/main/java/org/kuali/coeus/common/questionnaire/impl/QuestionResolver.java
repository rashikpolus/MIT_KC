...
public class QuestionResolver implements TermResolver<Object> {
    ...
    public static final String QUESTIONNAIRE_ID = "Questionnaire ID";
    ...
    public String resolve(Map<String, Object> resolvedPrereqs, Map<String, String> parameters) {
        String questionnaireId = parameters.get(QUESTIONNAIRE_ID);
        String questionId = parameters.get(QUESTION_ID);
