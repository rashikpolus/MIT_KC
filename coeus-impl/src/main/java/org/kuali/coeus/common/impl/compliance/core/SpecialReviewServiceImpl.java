...
public class SpecialReviewServiceImpl implements SpecialReviewService {
    ...
    public void addSpecialReviewForProtocolFundingSource(String fundingSourceNumber, String fundingSourceTypeCode, String protocolNumber, Date applicationDate, 
        ...
        boolean fundingSourceLinkEnabled = isFundingSourceLinkEnabled(specialReviewType, fundingSourceTypeCode);
        if (StringUtils.equals(FundingSourceType.AWARD, fundingSourceTypeCode) && fundingSourceLinkEnabled) {
            Award award = getAward(fundingSourceNumber);
        ...
        } else if (StringUtils.equals(FundingSourceType.INSTITUTIONAL_PROPOSAL, fundingSourceTypeCode) && fundingSourceLinkEnabled) {
            InstitutionalProposal institutionalProposal = getInstitutionalProposal(fundingSourceNumber);
        ...
        else if (StringUtils.equals(FundingSourceType.PROPOSAL_DEVELOPMENT, fundingSourceTypeCode) && fundingSourceLinkEnabled){
            DevelopmentProposal developmentProposal = getDevelopmentProposal(fundingSourceNumber);
    ...
    protected boolean isFundingSourceLinkEnabled(String specialReviewTypeCode, String fundingSourceTypeCode) {
        boolean linkEnabled = false;
    	if (SpecialReviewType.HUMAN_SUBJECTS.equals(specialReviewTypeCode)) {
    		linkEnabled = getProtocolFundingSourceService().isFundingSourceLinkEnabled(fundingSourceTypeCode);
        }
    	return linkEnabled;
    }
