...
public abstract class ProtocolFundingSourceServiceImplBase implements ProtocolFundingSourceService {
    ...
    public boolean isFundingSourceLinkEnabled(String fundingSourceTypeCode) {
    	boolean linkEnabled = false;
    	switch (fundingSourceTypeCode) {
        	case FundingSourceType.AWARD:
        		linkEnabled = isAwardLinkEnabled();
        		break;
        	case FundingSourceType.INSTITUTIONAL_PROPOSAL:
        		linkEnabled = isInstitionalProposalLinkEnabled();
        		break;
        	case FundingSourceType.PROPOSAL_DEVELOPMENT:
        		linkEnabled = isInstitionalProposalLinkEnabled();
        		break;
    	}
    	return linkEnabled;
