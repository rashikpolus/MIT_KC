...
public class ReportHelperBean implements Serializable {
    ...
    private class PendingReportHelperBean implements Serializable {
        ...
        public List<ResultRow> preparePendingReport() {
            ...
            int proposalTypeTaskOrder =  Integer.parseInt(KcServiceLocator.getService(ParameterService.class).
            ...
            int proposalTypeContinuation =  Integer.parseInt(KcServiceLocator.getService(ParameterService.class).
            		getParameterValueAsString(ProposalDevelopmentDocument.class, ProposalDevelopmentConstants.PropDevParameterConstants.PROPOSAL_TYPE_CODE_CONTINUATION_PARM));
            ...
            for(PendingReportBean bean: loadReportData()) {
                ...
                for(InstitutionalProposal institutionalProposal:institutionalProposalList){
                    ...
                    if(institutionalProposal.getProposalSequenceStatus().equals(PROP_SEQ_STATUS) && institutionalProposal.getStatusCode()== PROP_PENDING_STATUS 
                            && institutionalProposal.getProposalTypeCode()!= proposalTypeContinuation && institutionalProposal.getProposalTypeCode()!= proposalTypeTaskOrder ){
