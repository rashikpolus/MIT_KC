...
@Component("finalPatentReportAlertService")
public class FinalPatentReportAlertServiceImpl extends AlertServiceBaseImpl
	...
	public static final String REPORT_CLASS_CODE = "3";
	...
	public void createAlerts(AlertType alertType, String userName) {
		...
		for (Award award : myAwardsFiltered) {
			...
			alertMessage = getKualiConfigurationService().getPropertyValueAsString(KcMitConstants.FINAL_PATENT_REPORT_ALERT);
